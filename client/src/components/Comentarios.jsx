    ...
    <>
      ...
      >
        ...
        <form onSubmit={edition ? editComment : addComment}>
          ...
          <input
            name="title"
            className="border shadow-sm mt-2 rounded-md border-gray-200 w-full text-black"
          ...
          <textarea
            name="description"
            className="mt-2 border shadow-sm rounded-md border-gray-200 w-full text-black"
            onChange={(e) => handleChange(e)}
